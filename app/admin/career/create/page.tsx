...
export default function EditCareerForm() {
  ...
  useEffect(() => {
    ...
    async function loadCareer() {
      ...
      if (data.education?.includes("—")) {
        const [lvl, major] = data.education
          .split("—")
          .map((v: string) => v.trim());
  ...
  const handleRemoveDescription = (index: number) => {
    setDescriptionList((prev) => prev.filter((_, i) => i !== index));
  };
    ...
    <div className="min-h-screen bg-black pb-12 pt-6 text-gray-100">
      ...
      <div className="space-y-8 max-w-5xl">
        ...
        <div className="flex gap-6 items-start">
          <div className="w-1/2">
            ...
            <input
              value={jobCode}
              readOnly
              className={`w-full px-4 py-4 rounded-full bg-[#111] border ${
                errors.jobCode ? "border-red-400 bg-red-900/20" : "border-gray-700"
          ...
          <div className="flex-1">
            <label className="mb-1 block text-xs uppercase tracking-[0.2em] text-gray-500">
              Job Title <span className="text-adidaya-red">*</span></label>
              <InputWithOptions
              label=""
              value={title}
        ...
        <div className="flex gap-6 items-start">
          <div className="w-1/2">
          <label className="mb-1 block text-xs uppercase tracking-[0.2em] text-gray-500">
              Type <span className="text-adidaya-red">*</span></label>
            <InputWithOptions
              label=""
              value={type}
              placeholder="Select or type..."
        ...
        {/* ============= */}
        <div>
          <label className="mb-1 block text-xs uppercase tracking-[0.2em] text-gray-500">Education</label>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex-1 space-y-2">
            <label className="mb-1 block text-xs uppercase tracking-[0.2em] text-gray-500">
              Experience <span className="text-adidaya-red">*</span></label>
            <InputWithOptions
              label=""
              value={experience}
        ...
        <div>
          ...
          <DndContext
            ...
            onDragEnd={({ active, over }) => {
              ...
              setDescriptionList((items) => arrayMove(items, oldIndex, newIndex));
            }}
          >
            <SortableContext
